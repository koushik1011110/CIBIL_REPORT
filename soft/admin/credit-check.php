...
// Fetch Customers
$custStmt = $p->query('SELECT id, name, mobile, pan, credit_score, dob, credit_report_json FROM customers ORDER BY name');
$customers = $custStmt->fetchAll();

// Fetch Products & Variants
$prodStmt = $p->query('SELECT id, name, brand, category, selling_price, stock FROM products WHERE status="active" ORDER BY name');
...
start('Credit Check & Product EMI Calculator (Admin)');
?>
